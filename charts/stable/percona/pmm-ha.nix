{
  ...
  latest = "1.6.1";
  versions = {
    "1.6.1" = "sha256-Pul8VWTlAdfiEcUFdVNXZVs2VSPLxQbOAiVPDRYQzSM=";
    ...
    "1.4.0" = "sha256-QEqut6DD9cEiVhM+NbgnMDJdwD5YPWn2VrOC4bCsoCo=";
    "1.3.23" = "sha256-EJy0r6CkCR8UF+8eDtj11off4MICDng6UszWB32Uy2A=";
  };
}
