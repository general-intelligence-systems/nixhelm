{
  ...
  latest = "1.0.2";
  versions = {
    "1.0.2" = "sha256-YBep4nQ/3C5BDgsFJa12mWVaeCSu01m1LAdUWBQzlwA=";
    ...
    "0.2.0" = "sha256-vLV0OcKeQXUBGctU9+3fHcIphAJDsnHbvRLB8uajJsw=";
    "0.1.0" = "sha256-Yvsu8f6tcfJlLA8Hr6FCT/9AI+L/W6pCt6t5CDi1zKk=";
  };
}
